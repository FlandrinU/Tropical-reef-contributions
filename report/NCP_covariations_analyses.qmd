...
![](`r here::here("outputs", "figures", "Spatial correlation per distance NN, increment 500.png") `)  
![](`r here::here("outputs", "figures", "Spatial correlation per distance NS, increment 500.png") `)
...
![NN vs NS](`r here::here("outputs", "figures", "Sites in NN and NS scores _ with piecharts.png") `)
