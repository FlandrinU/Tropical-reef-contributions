...
```{r, echo= FALSE, warning=FALSE, fig.width= 12, fig.height= 7}
non_material <- names(grp_3cat)[ grp_3cat == "nature" ]
...
hist <- factoextra::fviz_eig(pca_non_material, addlabels = TRUE, ylim = c(0, 35), barfill = "forestgreen", barcolor = "forestgreen")

# var <- get_pca_var(pca_non_material)
# corrplot(var$contrib, is.corr=FALSE)

pca_plot <- fviz_pca_var(pca_non_material, col.var = "forestgreen",
             repel = TRUE
)
